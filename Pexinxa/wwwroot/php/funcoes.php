...
function menu_superior(){
    ...
    <div id='menusup'>
        ...
        <div id='menuinferior2'>
            <ul id='ulmenuinf'>
                <li id='limenuinf2'><a id='menu_inf2' href='index.php'><span class='material-symbols-outlined'>home</span>HOME</a></li>
                <li id='limenuinf2'><a id='menu_inf2' href='produtos.php'><span class='material-symbols-outlined'>Shopping_cart</span>PRODUTOS</a></li>
                <li id='limenuinf2'><a id='menu_inf2' href='mercado.php'><span class='material-symbols-outlined'>storefront</span>MERCADOS</a></li>
                <li id='limenuinf2'><a id='menu_inf2' href='listacompra.php'><span class='material-symbols-outlined'>receipt_long</span>LISTA</a></li>
            </ul>
        </div>
...
function footer(){
    ...
    <div class='logo_footer'>
        <img id='logo_footer' src='~/images/logotipo.png' alt='Logo'><p>Criado por: equipe Pexinxa</p>
        </div>
        <div class='social'>
...
function produtos($nome_produto, $mercado, $preco, $img, $img_mercado){
        
    echo"
         <div class='produtos data-name='".$nome_produto."' data-market='".$mercado."' data-price='".$preco."' id='prod'>
                ...
                <div class='modal-dialog' role='document'>
                    <div class='modal-content rounded-4 shadow'>
                        <div class='modal-header p-5 pb-4 border-bottom-0'>
                            <img src='imagens/logo.png' alt='logozin' class='logo' style='height: 60px; width: 60px; margin-right: 20px;'>
